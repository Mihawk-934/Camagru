...
//---------------------insertion imgdans la db page captur---------------------//
...
//---------------------recup gallery img avec paginiation et gallery---------------------//
...
//------------------ajouter like-------------------//
    ...
    function like_dislike($id_img,$id_user)
    {
        ...
        $res_like = $req_like->rowCount();//recup nb ligne
        $like_row = $req_like->fetch();//recup ligne db
        $id_like = $like_row[0];//recup id like
        if ($res_like == 0)
        {
