        ...
        <?php if($_SESSION != NULL)
            {
				...
				echo "<div class='card'>";
					...
					echo "<h1 style='color:black;'>".$_SESSION['pseudo']."</h1>";
					echo "<h1 style='color:black;'>".$_SESSION['lastname']."</h1>";
					echo "<h1 style='color:black;'>".$_SESSION['firstname']."</h1>";
					echo "<h2 style='color:black;'>".$_SESSION['mail']."</h2>";

						echo"<p><button id='mon_bouton' style='width:200px';><a id = 'profil_lien'href='../view/capture.php' style='color:white;'>Prendre une photo</a> </button>".  " ".
